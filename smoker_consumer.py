"""
    ...
    Three separate queues are used to listen for messages about the temperatures of the Smoker, Food A, and Food B.
...
def process_temperature(body, temperature_name, temperature_deque, alert_threshold):
    '''
    This function reads and shows the temperature recorded.
